...
final _sdk_routing_StreetAttributes_create_handle_nullable = __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Uint32),
    Pointer<Void> Function(int)
  >('here_sdk_sdk_routing_StreetAttributes_create_handle_nullable');
final _sdk_routing_StreetAttributes_release_handle_nullable = __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_routing_StreetAttributes_release_handle_nullable');
final _sdk_routing_StreetAttributes_get_value_nullable = __lib.nativeLibrary.lookupFunction<
